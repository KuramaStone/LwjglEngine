...
public class NoiseGen { // Simplex noise in 2D, 3D and 4D

	public static int RANDOMSEED = 0;
	private static int NUMBEROFSWAPS = 400;

	public float getNoise(float x, float z) {
		return (float) noise(x, z);
	}
	...
	private static short p_supply[] = { 151, 160, 137, 91, 90, 15, // this contains all the numbers between 0 and 255, these
																	// are put in a random order depending upon the seed
